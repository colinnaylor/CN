...
IF EXISTS (SELECT TOP 1 1
           FROM   [HELIUM].[BloombergDataLicense].[dbo].[ve_BloombergNonNorthAmericanPrice]
           WHERE  [EffectiveDate] = @thisdate)
  BEGIN
      DELETE dbo.TorViewBloombergNonNorthAmericanPrice;

      INSERT TorViewBloombergNonNorthAmericanPrice
