...
namespace SwiftImporterLib.Model
{
    ...
    public abstract class SwiftMessage : ISwiftMessage
    {
        ...
        public string ContainingSwiftFileName { get; set; }
        // ---
        ...
        public virtual string SqlAlreadyExistsString()
        {
            if (MessageInputReference == null)
                return "select 0"; // Assume not in DB

            var sql = "select count(*) from SwiftMessage \r\n";
            sql += "Where InputDate='{0}' and MessageInputReference='{1}' and SequenceNumber={2} and Direction='{3}'\r\n".Args(
               InputDate,
        ...
        public abstract string SqlInsertString();
